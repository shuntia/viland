...
impl Event {
    ...
    pub fn is_ctrl(&self) -> bool {
        self.key_code == KEY_LEFTCTRL || self.key_code == KEY_RIGHTCTRL
    }

    pub fn is_alt(&self) -> bool {
        self.key_code == KEY_LEFTALT || self.key_code == KEY_RIGHTALT
    }

    pub fn is_shift(&self) -> bool {
        self.key_code == KEY_LEFTSHIFT || self.key_code == KEY_RIGHTSHIFT
    }
    ...
    pub fn is_modifier(&self) -> bool {
        self.is_ctrl() || self.is_alt() || self.is_shift()
            || self.key_code == KEY_LEFTMETA || self.key_code == KEY_RIGHTMETA
            || self.key_code == KEY_CAPSLOCK
    }
}
